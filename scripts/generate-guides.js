  ...
  en: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "",
        "Example: If you invest $100 in the 3-day plan at 8% daily, after 3 days you'll earn $24.00. You can then choose to withdraw your capital and earnings or reinvest.",
        "",
        "REFERRAL COMMISSION:",
  ...
  es: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "• Plan de 3 Días: 8% de comisión diaria",
        ...
        "",
        "Ejemplo: Si invierte $100 en el plan de 3 días al 8% diario, después de 3 días ganará $24.00. Luego puede optar por retirar su capital y ganancias o reinvertir.",
        "",
  ...
  fr: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "• Plan de 3 Jours: 8% de commission quotidienne",
        ...
        "",
        "Exemple: Si vous investissez 100 $ dans le plan de 3 jours à 8% par jour, après 3 jours vous gagnerez 24,00 $. Vous pouvez ensuite choisir de retirer votre capital et vos gains ou de réinvestir.",
        "",
  ...
  de: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "• 3-Tage-Plan: 8% tägliche Provision",
        ...
        "",
        "Beispiel: Wenn Sie 100 $ im 3-Tage-Plan mit 8% täglich investieren, verdienen Sie nach 3 Tagen 24,00 $. Sie können dann wählen, Ihr Kapital und Ihre Gewinne abzuheben oder zu reinvestieren.",
        "",
  ...
  zh: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "• 6个月计划：每日5%佣金",
        "",
        "示例：如果您在3天计划中投资100美元，每日8%，3天后您将赚取24.00美元。然后您可以选择提取本金和收益或重新投资。",
        "",
        "推荐佣金：",
  ...
  ru: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "• План на 3 дня: 8% ежедневная комиссия",
        ...
        "",
        "Пример: Если вы инвестируете 100 долларов в 3-дневный план под 8% в день, через 3 дня вы заработаете 24,00 долларов. Затем вы можете выбрать, вывести свой капитал и прибыль или реинвестировать.",
        "",
  ...
  ar: {
    ...
    aboutCompany: {
      ...
      content: [
        ...
        "",
        "مثال: إذا استثمرت 100 دولار في خطة 3 أيام بنسبة 8% يومياً، بعد 3 أيام ستكسب 24.00 دولار. يمكنك بعد ذلك اختيار سحب رأس المال والأرباح أو إعادة الاستثمار.",
        "",
        "عمولة الإحالة:",
