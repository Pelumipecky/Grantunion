...
addParagraph('Bienvenido a Grant Union, la plataforma principal de inversión y trading en el mundo. Estamos comprometidos a proporcionarle una experiencia de inversión segura, transparente y rentable.');

addHeading2('Acerca de Grant Union');
addParagraph('Grant Union es una empresa profesional de trading especializada en trading de criptomonedas, trading de divisas, oro e inversiones en bienes raíces. Nuestro equipo de traders profesionales trabaja diligentemente para maximizar los retornos de sus inversiones en Bitcoin.');

addHeading3('Inversión Mínima');
addParagraph('La empresa ofrece comisión diaria basada en su plan de inversión. Con un depósito mínimo de solo $100, puede comenzar a ganar. Después de su período de inversión, puede optar por retirar tanto su capital como sus ganancias o reinvertir para un crecimiento continuo.');

addHeading1('Planes de Inversión y Retornos');
addParagraph('Nuestros Planes de Inversión:');
...
doc.text('Dep. Mín.', col4, tableTop + 6, { width: 85 });
doc.text('Dep. Máx.', col5, tableTop + 6, { width: 85 });
...
addParagraph('Si invierte $100 en el plan de 3 días al 8% diario, después de 3 días ganará $24.00. Puede optar por retirar su capital y ganancias o reinvertir.');

doc.moveDown(0.3);

addHeading2('Cómo Funciona');
addParagraph('Cuando invierte con Grant Union, nuestro equipo profesional de traders negocia su Bitcoin por la duración de su plan elegido (p. ej., 3 días). Después del período de inversión, su capital y ganancias se transfieren a su oficina trasera, donde puede optar por retirar o reinvertir.');

doc.moveDown(0.3);

addHeading2('Métodos de Pago');
addParagraph('Grant Union utiliza Bitcoin y USDT para todas las transacciones en la plataforma, asegurando accesibilidad rápida, segura y global.');
...
addParagraph('¡Grant Union ofrece una comisión de referencia ilimitada del 10% a todos los inversores! Gana el 10% de cada depósito realizado por cualquier persona que se registre usando tu enlace de referencia único.');
...
addParagraph('Los retiros son rápidos y eficientes. El proceso toma solo unos pocos minutos y como máximo dentro de 24 horas.');
...
addParagraph('Ya sea que desee retirar su capital después de que termine su período de inversión o tomar sus comisiones diarias, Grant Union lo hace rápido y conveniente.');
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'No hay límite en las ganancias de referencias. Gana el 10% de cada depósito realizado por cualquier persona que se registre usando su enlace de referencia. Cuantas más referencias haga, más gana.'
  },
  {
...
faqs.forEach((faq, idx) => {
  doc.fontSize(11).fillColor(primaryOrange).font('ArialBold').text('P: ' + faq.question, { width: 480 });
...
doc.fontSize(10).fillColor(lightText).font('ArialBold').text('© 2026 Grant Union. Todos los derechos reservados.', { align: 'center' });
doc.fontSize(9).text('Trading Profesional | Criptomonedas | Divisas | Oro | Bienes Raíces', { align: 'center' });
