  ...
  return (
    <div className="paymentSect">
        ...
        <div className="mainPaymentSect">
            ...
            <p>{investData?.paymentOption === "Bitcoin" ? "12mmqmLsULbMTDCuP5ESCiDApW7p3CfeSL" : "heretoo"} <span onClick={() => {copyToClipboard(`${investData?.paymentOption === "Bitcoin" ? "12mmqmLsULbMTDCuP5ESCiDApW7p3CfeSL" : "12mmqmLsULbMTDCuP5ESCiDApW7p3CfeSL"}`)}}>{copystate} <i className="icofont-ui-copy"></i></span></p>
        </div>
